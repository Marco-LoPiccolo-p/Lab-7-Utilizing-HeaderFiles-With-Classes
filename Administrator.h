...
#ifndef ADMINISTRATOR_H        //Used to make sure no header file is included more than once, this is used in conjunction with #define and #endif all in capital letters with an underscore to replace the period
